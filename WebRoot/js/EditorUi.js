...
EditorUi = function(editor, container)
{
	...
	var webserviceGraph = editor.webserviceGraph;
	...
	// graph.init(this.webserviceContainer);
	// graph.refresh();
 ...
 */
EditorUi.prototype.menubarHeight = 68;
 ...
 * Saves the current graph under the given filename.
 */
EditorUi.prototype.generateSpark = function(name)
{
	if (name != null)
	{
		var xml = mxUtils.getXml(this.editor.getGraphXml());
...
EditorUi.prototype.refresh = function()
{
	...
	this.diagramContainer.style.top = (this.menubarHeight + this.toolbarHeight+20) + 'px';
	this.codeContainer.style.left = (effHsplitPosition + this.splitSize) + 'px';
	this.codeContainer.style.top = (this.menubarHeight + this.toolbarHeight+20) + 'px';
	this.codeContainer.style.bottom = this.footerHeight + 'px';
	this.codeContainer.style.right = 0 + 'px';
	this.resultContainer.style.left = (effHsplitPosition + this.splitSize) + 'px';
	this.resultContainer.style.top = (this.menubarHeight + this.toolbarHeight+20) + 'px';
	this.resultContainer.style.bottom = this.footerHeight + 'px';
	this.resultContainer.style.right = 0 + 'px';
	this.webserviceContainer.style.left = (effHsplitPosition + this.splitSize) + 'px';
	this.webserviceContainer.style.top = (this.menubarHeight + this.toolbarHeight+20) + 'px';
	this.webserviceContainer.style.right = 0 + 'px';
	this.webserviceContainer.style.bottom = this.footerHeight + 'px';
	this.webserviceContainer.style.margin=0+'px';
	this.webserviceContainer.style.position='absolute';
...
EditorUi.prototype.createDivs = function()
{
	...
	this.codeContainer = this.createDiv('geCodeContainer');
	this.resultContainer = this.createDiv('geResultcontainer');
	this.webserviceContainer = this.createDiv('geWebServiceContainer');
	this.footerContainer = this.createDiv('geFooterContainer');
	this.loadingBackgroundContainer = this.createDiv('geLoading');
...
{
	// Creates menubar
	var logoDiv = this.createDiv('logoDiv');
	var img = document.createElement("img");
	img.src = "images/logo.png";
	img.setAttribute("class", "logoImg");
	logoDiv.appendChild(img);
	var titleDiv = this.createDiv('titleDiv');
	titleDiv.innerHTML="EDSV物联网服务平台";
	this.menubar = this.menus.createMenubar(this.createDiv('geMenubar'));
	this.menubarContainer.appendChild(logoDiv);
	this.menubarContainer.appendChild(titleDiv);
	...
	// this.webserviceContainer.appendChild(btngroup);

	// var content = document.createElement("div");
	// content.className="resContent";
	// this.webserviceContainer.appendChild(content);
	...
	this.container.appendChild(this.webserviceContainer);
	this.container.appendChild(this.footerContainer);
	this.container.appendChild(this.loadingBackgroundContainer);
...
EditorUi.prototype.createKeyHandler = function(editor)
{
    ...
    bindAction(69, true, 'export'); // Ctrl+E
    bindAction(71, true, 'generate');//Ctrl+G
