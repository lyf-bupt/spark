...
public class FileUploadServlet extends HttpServlet{
    protected void doPost(HttpServletRequest request,
        ...
        try {  
            ...
            response.sendRedirect("wsCenter.html");
    ...
    public void registerSCA(String name,List<String> methods,String URL,String path){
    	...
    	for(String method:methods){
    		sql = "INSERT INTO methods (serviceId, URL, name, method) VALUES ('"+id+"', '"+URL+"','"+method+"','"+method+"')";
    		ct.execute(sql);
    	}
    	ct.close();
    }
