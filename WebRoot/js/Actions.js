...
Actions.prototype.init = function()
{
	...
	this.addAction('generate',function(){ ui.showDialog(new GenerateDialog(ui).container, 300, 100, true, true); }, null, null, 'Ctrl+G');
	...
	this.addAction('filter',function(){
		if(!mxConstants.SOURCE){
			alert("请先选择数据源");
			return false;
		}
		$.post('./topic',{source:mxConstants.SOURCE},function(req){
			ui.showDialog(new filterDialog(ui,req).container, 400, 250, true, true);
		});
		},null,null,null);
	this.addAction('map',function(){
		if(!mxConstants.SOURCE){
			alert("请先选择数据源");
			return false;
		}
		$.post('./topic',{source:mxConstants.SOURCE},function(req){
			ui.showDialog(new mapDialog(ui,req).container, 400, 250, true, true);
		});
		},null,null,null);
	...
	this.addAction('outputModel',function(){
		if(!mxConstants.SOURCE){
			alert("请先选择数据源");
			return false;
		}
		$.post('./topic',{source:mxConstants.SOURCE,type:'view'},function(req){
			ui.showDialog(new OutputModelDialog(ui,req).container, 400, 100, true, true);
		});
		},null,null,null);
	...
	this.addAction('wsBench',function(){
		window.open('wsCenter.html');
	});
